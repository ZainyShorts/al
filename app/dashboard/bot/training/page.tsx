...
<br/>
{ audio == false && <label  className={`${styles.customFileUpload} relative`}>
    <div className={styles.icon}>
    <FaFileAudio  size={60} className={styles.svg}/>
    </div>
    <div className={styles.text}>
    <span className={styles.span}>Upload Audio File</span>
    <input onChange={(e)=>handleFileChange(e)} accept=".mp3" className="absolute inset-0 opacity-0 w-full h-full cursor-pointer" type="file" />
    </div>
</label>}
{
    audio == true
    && 
    <div className='pr-20'>
            <audio src={audioSrc}  id='audio-tag' controls/>
    </div>
