...
const manualDataSet = () =>{
  ...
  const { work , setWork  , updateLead} = useMyContext()
    ...
    <div className={styles.container}>
        ...
        <div className={styles.formContainer}>
          <form className={styles.form}>
            ...
            <input type='text'  name="countryCode" placeholder='Required' value={work.countryCode} onChange={handleChange}  />
            ...
            <input type='text'  name="dob" placeholder='Optional' value={work.dob} onChange={handleChange}  />
            ...
            <button onClick={(e)=>updateLead(e,edit)}>Update</button>
          </form>
        </div>
      </div>
    </>
